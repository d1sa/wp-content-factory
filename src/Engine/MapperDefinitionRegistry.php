...
final class MapperDefinitionRegistry {
	public function attributes( string $id ): array {
		$definitions = array(
			'potolki.hero' => array( 'kicker'=>'string','title'=>'string','lead1'=>'string','lead2'=>'string','hasLeadBlocks'=>'boolean','buttonLabel'=>'string','buttonUrl'=>'string','buttonTarget'=>'string','buttonRel'=>'string','phoneCaption'=>'string','phoneLabel'=>'string','phoneUrl'=>'string','benefit1'=>'string','benefit2'=>'string','benefit3'=>'string','imageId'=>'number','imageUrl'=>'string','imageAlt'=>'string','badgeValue'=>'string','badgeText'=>'string','noteTitle'=>'string','noteText'=>'string','noteUrl'=>'string' ),
