...
final class MapperDefinitionRegistry {
	public function attributes( string $id ): array {
		$definitions = array(
			'potolki.hero' => array( 'kicker'=>'string','title'=>'string','lead1'=>'string','lead2'=>'string','hasLeadBlocks'=>'boolean','buttonLabel'=>'string','buttonUrl'=>'string','buttonTarget'=>'string','buttonRel'=>'string','variant'=>array('type'=>'string','enum'=>array('image-phone','inline-phone')),'phoneCaption'=>'string','phoneLabel'=>'string','phoneUrl'=>'string','benefit1'=>'string','benefit2'=>'string','benefit3'=>'string','imageId'=>'number','imageUrl'=>'string','imageAlt'=>'string','showBadge'=>'boolean','badgeValue'=>'string','badgeText'=>'string','noteTitle'=>'string','noteText'=>'string','noteUrl'=>'string' ),
